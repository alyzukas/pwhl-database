...
INSERT INTO location (location_key, name, address, seat_capacity, open_date) VALUES
  ...
  (7, 'Climate Pledge Arena', '334 1st Ave N, Seattle, WA 98109, USA', 17151, '1968-01-08'),
  (8, 'Pacific Coliseum', '100 North Renfrew St, Vancouver, BC V5K 3N9, Canada', 16281, '2021-10-15');
...
-- 7) Shot
INSERT INTO shot (shot_key, shot_time, shooter_key, game_key, goalie_key, blocker_key, is_goal, shot_quality, shot_type, x_location, y_location) VALUES
  (16, '2000-01-01 00:06:20', 34, 259, 6, 149, 0, 'Non quality blocked', 'Default', 175, 143),
  (36, '2000-01-01 00:12:28', 12, 259, 155, NULL, 1, 'Non quality goal', 'Slap', 423, 203),
  (41, '2000-01-01 00:13:50', 12, 259, 155, 99, 0, 'Non quality blocked', 'Slap', 434, 217),
  (43, '2000-01-01 00:14:00', 246, 259, 155, 49, 0, 'Non quality blocked', 'Default', 389, 173),
  (75, '2000-01-01 00:25:47', 210, 259, 6, NULL, 1, 'Non quality goal', 'Slap', 81, 67),
  (4,  '2000-01-01 00:01:18', 76, 261, 155, NULL, 1, 'Quality goal', 'Wrist', 513, 196),
  (47, '2000-01-01 00:09:52', 13, 261, 211, NULL, 1, 'Non quality goal', 'Wrist', 48, 178),
  (51, '2000-01-01 00:10:54', 138, 261, 211, 76, 0, 'Non quality blocked', 'Backhand', 70, 99),
  (55, '2000-01-01 00:12:33', 244, 261, 155, NULL, 0, 'Quality on net', 'Wrist', 525, 170),
  (57, '2000-01-01 00:13:49', 181, 261, 211, NULL, 1, 'Non quality goal', 'Tip', 39, 165),
  (109,'2000-01-01 00:30:30', 68, 261, 155, NULL, 1, 'Non quality goal', 'Wrist', 406, 153),
  (203,'2000-01-01 00:58:14', 36, 261, 211, NULL, 1, 'Quality goal', 'Wrist', 99, 147);

-- 8) Goal
INSERT INTO goal (goal_key, shot_key, is_power_play, is_short_handed, is_empty_net, is_penalty_shot, is_insurance_goal, is_game_winning_goal) VALUES
  (37, 36, 1, 0, 0, 0, 0, 0),
  (5, 4, 0, 0, 0, 0, 0, 0),
  (17, 16, 0, 0, 0, 0, 0, 0),
  (48, 47, 1, 0, 0, 0, 0, 0),
...
-- 9) Assist (FIXED goal_key)
INSERT INTO assist (assist_key, goal_key, player_key, assist_number) VALUES
  (371, 37, 34, 1),
  (372, 37, 12, 2),
  (761, 58, 181, 1),
  (762, 58, 210, 2);
...
-- 10) Tenure 
INSERT INTO tenure
  (tenure_key, player_key, team_key, season_key, captain, jersey_number, position)
VALUES
  (25, 6,   1, 8, NULL,        44, 'LW'),
  (16, 12,  1, 8, NULL,        77, 'C'),
